...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: ivonnemendoza
--
...
ALTER TABLE public.employees OWNER TO ivonnemendoza;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: ivonnemendoza
--
